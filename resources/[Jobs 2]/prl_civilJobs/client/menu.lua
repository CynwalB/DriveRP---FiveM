RMenu.Add('LifeInvaders', 'main', RageUI.CreateMenu("Jobs", " "))
RMenu:Get('LifeInvaders', 'main'):SetSubtitle("~b~Jobs central d'intérim")
RMenu:Get('LifeInvaders', 'main'):SetRectangleBanner(0, 0, 0, 255)
