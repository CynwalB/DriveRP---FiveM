local int_stock = GetInteriorAtCoordsWithType(162.10260,-1711.327,22.207,"int_stock")
...
--local int_stock7 = GetInteriorAtCoordsWithType(-67.78810,-1291.193,23.791,"weapon")
...
local int_stock10 = GetInteriorAtCoordsWithType(-41.5310,6453.3046,24.329,"int_stock")
local int_stock11 = GetInteriorAtCoordsWithType(1397.311,-2092.379,45.499,"int_stock")
--local int_stock12 = GetInteriorAtCoordsWithType(2862.444,4456.0014,41.322,"int_stock")
local int_stock13 = GetInteriorAtCoordsWithType(552.5862,2684.1770,35.043,"int_stock")
--local interiorHash4 = GetInteriorAtCoordsWithType(963.7479,3632.5056,25.761,"int_stock")
local int_stock14 = GetInteriorAtCoordsWithType(2536.508,4118.2700,31.460,"int_stock")
--local interiorHash6 = GetInteriorAtCoordsWithType(436.5493,-1970.364,17.290,"int_stock")

--DisableInteriorProp
--EnableInteriorProp
local allInterior = {
    {interior = int_stock, loaded = false, data = {"weed_app","weed_staff_01","weed_staff_02","weed_update_lamp","weed_fan_update","weed_stock","weed_plant_v7"}},
    {interior = int_stock3, loaded = false, data = {"light_stock","meth_app","meth_staff_01","meth_staff_02","meth_basic_lab_01","meth_basic_lab_02","meth_basic_lab_01_2","meth_basic_lab_02_2","meth_stock"}},
    {interior = int_stock4, loaded = false, data = {"coke_app","coke_staff_01","coke_staff_02","coke_stock"}},
    {interior = int_stock5, loaded = false, data = {"weed_app","weed_staff_01","weed_staff_02","weed_update_lamp","weed_fan_update","weed_stock","weed_plant_v7"}},
    {interior = int_stock6, loaded = false, data = {"light_stock","money_app","money_staff_01","money_stock","money_staff_01","money_staff_02"}},
    {interior = int_stock8, loaded = false, data = {"light_stock","money_app","money_staff_01","money_stock","money_staff_01","money_staff_02"}},
    {interior = int_stock9, loaded = false, data = {"light_stock","meth_app","meth_staff_01","meth_staff_02","meth_basic_lab_01","meth_basic_lab_02","meth_basic_lab_01_2","meth_basic_lab_02_2","meth_stock"}},
    {interior = int_stock10, loaded = false, data = {"weed_app","weed_staff_01","weed_staff_02","weed_update_lamp","weed_fan_update","weed_stock","weed_plant_v7"}},
    {interior = int_stock11, loaded = false, data = {"coke_app","coke_staff_01","coke_staff_02","coke_stock"}},
   -- {interior = int_stock12, loaded = false, data = {"coke_app","coke_staff_01","coke_staff_02","coke_stock"}},
    {interior = int_stock13, loaded = false, data = {"light_stock","weapon_app","weapon_staff_01","weapon_stock"}},
    {interior = int_stock14, loaded = false, data = {"light_stock","weapon_app","weapon_staff_01","weapon_stock"}},
}
local s1methba
local s1methup
local s1weedba
...
RegisterCommand("getInterior", function(source,args,rawCommand)
    local ped = PlayerPedId()
    local interiorId = GetInteriorFromEntity(ped)
    local pos, nameHash, hash = GetInteriorInfo(interiorId)
    print(hash)
end)



local function loadInteriorData(interior,data)
    RefreshInterior(interior)
    for k,v in pairs(data) do
        EnableInteriorProp(interior, v)
    end
end

local function unloadInteriorData(interior,data)
    RefreshInterior(interior)
    for k,v in pairs(data) do
...
Citizen.CreateThread(function()
    while true do
        ...
        for k,v in pairs(allInterior) do
            if interior == v.interior and v.loaded == false then
                loadInteriorData(interior,v.data)
                v.loaded = true
            elseif v.loaded == true then
                if interior ~= v.interior then
                    unloadInteriorData(interior,v.data)
                    v.loaded = false
                end
            end
        end
