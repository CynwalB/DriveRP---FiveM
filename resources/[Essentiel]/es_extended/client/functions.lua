...
RegisterNetEvent('pickup:animation')
AddEventHandler('pickup:animation', function()
    Citizen.CreateThread(function()
...
--        TaskPlayAnim(ped, 'mp_common', 'givetake1_a', 8.0, -8, 10.0, 49, 0, 0, 0, 0)
		...
		TaskPlayAnim(ped, 'weapons@first_person@aim_rng@generic@projectile@sticky_bomb@', 'plant_floor', 8.0, -8, 10.0, 49, 0, 0, 0, 0)
        Citizen.Wait(1500)
        ClearPedSecondaryTask(ped)
    end)
end)

RegisterNetEvent('drop:animation')
AddEventHandler('drop:animation', function()
    Citizen.CreateThread(function()
        local ped = PlayerPedId()
--        RequestAnimDict('mp_common')
--        TaskPlayAnim(ped, 'mp_common', 'givetake1_a', 8.0, -8, 10.0, 49, 0, 0, 0, 0)
...
RegisterNetEvent('giveplayer:animation')
AddEventHandler('giveplayer:animation', function()
    Citizen.CreateThread(function()
        local ped = PlayerPedId()
...
RegisterNetEvent('givetarget:animation')
AddEventHandler('givetarget:animation', function()
    Citizen.CreateThread(function()
        local ped = PlayerPedId()
--        RequestAnimDict('move_m@_idles@shake_off') paper_1_rcm_alt1-9
--        TaskPlayAnim(ped, 'move_m@_idles@shake_off', 'move_m@_idles@shake_off', 8.0, -8, 10.0, 49, 0, 0, 0, 0)
