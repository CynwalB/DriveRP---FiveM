...
if GetConvar('voice_useNativeAudio', 'false') == 'true' then
	...
	Cfg.voiceModes = {
		{1.5, "chuchotez"}, -- Whisper speech distance in gta distance units
		{3.0, "parlez normalement"}, -- Normal speech distance in gta distance units
		{6.0, "criez"} -- Shout speech distance in gta distance units
	}
else
	Cfg.voiceModes = {
		{3.0, "chuchotez"}, -- Whisper speech distance in gta distance units
		{7.0, "parlez normalement"}, -- Normal speech distance in gta distance units
		{15.0, "criez"} -- Shout speech distance in gta distance units
	}
end
