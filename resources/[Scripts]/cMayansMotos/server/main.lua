...
local Vehicles = nil
local societylabel = ""
RegisterServerEvent('sCustom:buyModmayansm')
AddEventHandler('sCustom:buyModmayansm', function(price)
	local _src = source
	--TriggerEvent("ratelimit", _src, "sCustom:buyModmayansm")
	...
	TriggerEvent('esx_addonaccount:getSharedAccount', "society_mayansm", function(account)
