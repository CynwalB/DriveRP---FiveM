...
Config.Global = {
    ...
    -----------------------------------------------------------------------------------
    PropsMax = 10, -- Props posable au maximum 
}
...
Config.Props = {

    {
        ...
        name = "Police", -- Nom de la catégorie 
        job = "police", -- job qui vois cette catégorie (nil = tout le monde)
        job2 = nil, -- job2 qui vois cette catégorie (nil = tout le monde)
        Props = {
            -- Label = Nom dans le menu 
            -- Model = https://forge.plebmasters.de/objects
            {Label = "Test Roulant", Model = "prop_wheelchair_01"},
        },
    },
