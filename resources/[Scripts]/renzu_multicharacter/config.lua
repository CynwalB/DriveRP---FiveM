Config = {}
Config.Locale = 'en'
Config.UseDefaultRegister = false -- if false you will use other registration resource ex. esx_identite,
Config.RegisterHook = {
	event = true,
...
Config.SkinMenus = {
	['Sneakyskinchanger'] = {
		['esx_skin'] = {event = 'esx_skin:openSaveableMenu', use = false},
		['VexCreator'] = {event = 'VexCreator:loadCreator', use = false},
		['cui_character'] = {event = 'cui_character:open', use = false},
		['Sneakyskinchanger'] = {exports = 'Sneakyskinchanger:loadSkin', event = nil, use = true}, -- example support exports
	},
...
local skincount = {}
local lowpriority = 'Sneakyskinchanger' -- for people who started 2 skin resource :facepalm
...
if #skincount > 1 then
	warn('you have multiple skin resource started. start only 1 supported skin resource. ex. fivem-appearance, Sneakyskinchanger cannot be started at the same time!')
