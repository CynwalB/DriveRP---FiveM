...
isSkinValid = function(skins)
	...
	if skin == 'Sneakyskinchanger' then return true end -- only check other resource
...
SetSkin = function(ped,skn)
	if Config.skin == 'Sneakyskinchanger' then
		TriggerEvent('Sneakyskinchanger:loadSkin', skn)
...
SkinMenu = function()
	if Config.skin == 'Sneakyskinchanger' then
		TriggerEvent('Sneakyskinchanger:loadSkin', skin, function()
...
LoadSkin = function()
	if Config.skin == 'Sneakyskinchanger' then
		TriggerEvent('Sneakyskinchanger:loadSkin', characters[chosenslot].skin)
	elseif Config.skin == 'fivem-appearance' then
