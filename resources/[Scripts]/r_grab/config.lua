...
Config = {
    ...
    Animations = {
        policeAnimation = {
            enabled = false, -- Activate or not the animation of the policeman when he takes a person by the arm.
...
Config.Keys = {
    ...
    TaskEnterKey = 56, -- Button to put the person inside the vehicle
    TaskEnterKeyString = '~INPUT_DROP_WEAPON~' -- Name of the button to put the person inside the vehicle
}
