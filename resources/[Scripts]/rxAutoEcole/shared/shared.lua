...
ConfigAutoEcole = {
    ...
    PositionCode = { x = 219.3519, y = -1392.28, z = 30.58354 },                   -- Position du code
    PositionCodePed = { x = 219.2, y = -1392.4648, z = 29.59364, h = 324.45},      -- Position du ped
    PrixCode = 500,                                                                 -- Prix du code
    PrixPermisVoiture = 1200,                                                       -- Prix du permis de voiture
    PrixPermisMoto = 1400,                                                          -- Prix du permis de moto
    PrixPermisCamion = 2000,                                                        -- Prix du permis de camion
