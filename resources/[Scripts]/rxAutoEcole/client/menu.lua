        ...
        CreateThread(function()
            while examen_menu do
                ...
                RageUI.IsVisible(menu_examen_1, function()
                    ...
                    RageUI.Button('80 km/h', nil, {RightLabel = ("→→")}, true, {
                    }, menu_examen_2)
                end)
                ...
                RageUI.IsVisible(menu_examen_4, function()
                    ...
                    RageUI.Button('Quand il est rouge', nil, {RightLabel = ("→→")}, true, {
                        onSelected = function()
                            ErreurPermis = ErreurPermis + 1
                        end
                    }, menu_examen_5)
                ...
                RageUI.Button('Après avoir marqué un stop de 3s', nil, {RightLabel = ("→→")}, true, {
                    }, menu_examen_5)
                end)
                ...
                RageUI.IsVisible(menu_examen_6, function()
                    ...
                    RageUI.Button('120 km/h', nil, {RightLabel = ("→→")}, true, {
                    }, menu_examen_7)
                ...
                RageUI.IsVisible(menu_examen_7, function()
                    ...
                    RageUI.Button('Je passe le plus vite possible au garage', nil, {RightLabel = ("→→")}, true, {
                    }, menu_examen_8)
                    ...
                    RageUI.Button("Je saute de ma voiture car risque d'explosion", nil, {RightLabel = ("→→")}, true, {
                        onSelected = function()
                            ErreurPermis = ErreurPermis + 1
                        end
                    }, menu_examen_8)
                ...
                RageUI.IsVisible(menu_examen_8, function()
                    ...
                    RageUI.Button('3m sur autoroute et 1m en ville', nil, {RightLabel = ("→→")}, true, {
                        onSelected = function()
                            ErreurPermis = ErreurPermis + 1
                        end
                    }, menu_examen_9)

                    RageUI.Button('30m sur autoroute et 10m en ville', nil, {RightLabel = ("→→")}, true, {
                        onSelected = function()
                            ErreurPermis = ErreurPermis + 1
                        end
                    }, menu_examen_9)
