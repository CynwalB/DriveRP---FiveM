...
if Config.EnableXtoCancel then
    RegisterKeyMapping("emotecancel", "Annuler animation en cours", "keyboard", Config.CancelEmoteKey)
end
...
if Config.MenuKeybindEnabled then
    ...
    RegisterKeyMapping("emoteuiwc", "Ouvrir menu emote", "keyboard", Config.MenuKeybind)
else
