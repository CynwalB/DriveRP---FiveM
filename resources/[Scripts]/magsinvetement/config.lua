...
Config.shops = {
    ...
    {pos = vector3(-1450.33, -237.41, 48.88), shop = "Main", color = {r=200, g=118, b=51}},

    {pos = vector3(-1337.69, -1277.76, 3.90), shop = "Masque", color = {r=1, g=118, b=51}},
    {pos = vector3(556.0035, 2675.908, 42.15779), shop = "Masque", color = {r=1, g=118, b=51}}, 
    {pos = vector3(-200.2129, 6352.457, 31.48807), shop = "Masque", color = {r=1, g=118, b=51}},  
}
