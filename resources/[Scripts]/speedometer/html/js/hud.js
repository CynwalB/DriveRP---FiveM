...
window.addEventListener("message", function(event) {
	...
	if (item.ShowHud) {
		...
		// Handbrake
		if(s_Handbrake) {
			$(".handbrake").html("FREIN À  MAIN")
		} else {
			$(".handbrake").html('<span class="gray">FREIN À  MAIN</span>')
		}
		...
		if(s_fuelamount != 0) {
			$(".fuel").html('ESSENCE<span class="gray" style="margin-left: 5px">'+s_fuelamount+'</span>')
		}
		...
		if(s_Brake > 0) {
			...
			$(".abs").html('<span class="gray">FREIN</span>')
		}
