config = {
    ...
    commandErrorMessage = 'Vous ne faites pas partis des forces de l\'ordre !', -- Message to show to people who try to do the command but don't have the permissions
