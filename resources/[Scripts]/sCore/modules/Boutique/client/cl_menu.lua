...
function OpenBoutiqueMenuRageUIMenu()
    ...
    if sBoutique.Menu then 
        ...
        RMenu.Add('boutique', 'history', RageUI.CreateSubMenu(RMenu:Get("boutique", "main"),"", "Boutique de Drive~q~RP~s~"))
        RMenu.Add('boutique', 'itemmenu', RageUI.CreateSubMenu(RMenu:Get("boutique", "main"),"", "Boutique de Drive~q~RP~s~"))
        RMenu:Get('boutique', 'main'):SetSubtitle("Boutique de Drive~q~RP~s~")
...
-- Keys.Register('F1','OpenBoutiqueMenuRageUIMenu', 'Boutique Drive~q~RP~s~', function()
