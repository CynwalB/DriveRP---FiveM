...
RMenu.Add('animation', 'main', RageUI.CreateMenu("", "Animations", 0, 0,'root_cause',"sneakylife"))
RMenu.Add('animation', 'ai', RageUI.CreateSubMenu(RMenu:Get('animation', 'main'), "", "Animations"))
RMenu.Add('animation', 'aj', RageUI.CreateSubMenu(RMenu:Get('animation', 'ai'), "", "Animations"))
                        ...
                        for a8, ar in ipairs(l) do
                            if Infos.NameMenu == "Bind l'animation" and not ar.Assign then
                                RageUI.Button("Touches n°" .. a8,"Assigner l'animation à cette touche",{RightLabel = "→"}, true, function(h,a,s)
                                    if s then
                                        RageUI.GoBack()
                                        ShowNotification("Vous avez bind l'animations: ~q~" ..Infos.ListId .. "~s~ sur la touche: ~q~" ..a8 .. "~s~.")
                            ...
                            elseif Infos.NameMenu == "Supprimer l'animation des binds" and ar.Assign then
                                RageUI.Button("Touches n°" .. a8,"Supprimer l'animation à cette touche",{RightLabel = "→"}, true, function(h,a,s)
                                    if s then
                                        ShowNotification("~r~Vous avez supprimé une animations sur la touche: ~q~" ..a8 .. "~s~.")
                                        a7(a8, false)
                                    end
                                end)
                            end
