...
AddEventHandler("Peche:givefish", function()
    ...
    if chance >= 0 and chance <= 18 then
        if xPlayer.canCarryItem("whitefish", 1) then
            ...
            TriggerClientEvent('esx:showNotification', source, 'Vous avez pêché un ~q~Poisson blanc.~q~ +1')
        else
    ...
    elseif chance >= 18 and chance <= 37 then
        if xPlayer.canCarryItem("fish", 1) then
            ...
            TriggerClientEvent('esx:showNotification', source, 'Vous avez pêché un ~q~Poisson.~q~ +1')
        else
            TriggerClientEvent("esx:showNotification", source, "~r~Vous n'avez pas assez de place.")
        end
    elseif chance >= 37 and chance <= 53 then
        if xPlayer.canCarryItem("redfish", 1) then
            ...
            TriggerClientEvent('esx:showNotification', source, 'Vous avez pêché un ~q~Poisson rouge.~q~ +1')
        else
            TriggerClientEvent("esx:showNotification", source, "~r~Vous n'avez pas assez de place.")
        end
    elseif chance >= 53 and chance <= 68 then
        if xPlayer.canCarryItem("fishd", 1) then
            ...
            TriggerClientEvent('esx:showNotification', source, 'Vous avez pêché un ~q~Poisson abattu.~q~ +1')
        else
            TriggerClientEvent("esx:showNotification", source, "~r~Vous n'avez pas assez de place.")
        end
    elseif chance >= 68 and chance <= 85 then
        if xPlayer.canCarryItem("carpecuir", 1) then
            ...
            TriggerClientEvent('esx:showNotification', source, 'Vous avez pêché une ~q~Carpe cuir.~q~ +1')
        else
            TriggerClientEvent("esx:showNotification", source, "~r~Vous n'avez pas assez de place.")
        end
    elseif chance >= 85 and chance <= 99 then
        if xPlayer.canCarryItem("pompom", 1) then
            ...
            TriggerClientEvent('esx:showNotification', source, 'Vous avez pêché un ~q~Poisson pompom.~q~ +1')
        else
            TriggerClientEvent("esx:showNotification", source, "~r~Vous n'avez pas assez de place.")
        end
    end
