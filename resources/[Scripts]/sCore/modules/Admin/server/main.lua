...
RegisterCommand("annonce",function(source, args, rawCommand)
	if source == 0 then
		if args[3] then
			...
			TriggerClientEvent("RageUI:DrawText", -1, {message = "Annonce : ~q~"..announce, time_display = 1000*15})
		else
	...
	if _src then
		...
		if xPlayer then
			...
			if tPlayer then
				...
				TriggerClientEvent("esx:showNotification", source, "Vous avez ~o~wipe~s~ le joueur ~q~"..GetPlayerName(tPlayer.source).."~s~ !")
...
local function wipeOffline(license, source)
	if source ~= 0 then
		...
		if tPlayer ~= nil then
			...
			TriggerClientEvent("esx:showNotification", source, "Vous avez ~o~wipe~s~ la license ~q~"..license.."~s~ !")
...
AddEventHandler("core:Message", function(id, type)
    ...
    sendToDiscord("DriveRP", "[STAFF] Message à "..GetPlayerName(id).. " avec comme message : "..type, 47103, "https://discord.com/api/webhooks/1151181162031624243/L7jDvHVGTD0z4Fros0o_90EqVCoTRuUfHgRKNlxG_oYT7_AohUzokosnD2uSym7JRrbG" )
...
--    TriggerClientEvent('esx:showNotification', xTarget.source, "Vous venez d'obtenir le métier : ~q~<C>"..job.."<C> ("..grade..")~s~")
end)
...
AddEventHandler('SneakyAdmin:setjob2', function(id, job2, grade2)
    ...
    TriggerClientEvent('esx:showNotification', xTarget.source, "Vous venez d'obtenir le groupe : ~q~<C>"..job2.."<C> ("..grade2..")~s~")
end)
...
AddEventHandler("SneakyLog:StaffActivé",function()
    local _src = source
    sendToDiscord("DriveRP", "[STAFF] Activé", 47103, "https://discord.com/api/webhooks/1151180241428029521/5Bo9p7uTlEOutHg4tZxHsFzOQhLsPepQaraiCPh_TAv8ScX5uNXNslUIvSlc9bljWgqc")
end)
RegisterServerEvent("SneakyLog:StaffDesactivé")
AddEventHandler("SneakyLog:StaffDesactivé",function()
    local _src = source
    sendToDiscord("DriveRP", "[STAFF] Désactivé", 16711680, "https://discord.com/api/webhooks/1151180241428029521/5Bo9p7uTlEOutHg4tZxHsFzOQhLsPepQaraiCPh_TAv8ScX5uNXNslUIvSlc9bljWgqc" )
end)
...
AddEventHandler("SneakyLog:Goto",function(IdSelected)
    ...
    sendToDiscord("DriveRP", "[STAFF] Goto sur "..GetPlayerName(IdSelected), 47103, "https://discord.com/api/webhooks/1151181162031624243/L7jDvHVGTD0z4Fros0o_90EqVCoTRuUfHgRKNlxG_oYT7_AohUzokosnD2uSym7JRrbG")
end)
...
AddEventHandler("SneakyLog:Freeze",function(IdSelected)
    ...
    local namestaff = GetPlayerName(source)
    if IdSelected == nil or namestaff == nil then return end
    sendToDiscord("DriveRP", "[STAFF] Freeze sur "..GetPlayerName(IdSelected), 47103, "https://discord.com/api/webhooks/1151181162031624243/L7jDvHVGTD0z4Fros0o_90EqVCoTRuUfHgRKNlxG_oYT7_AohUzokosnD2uSym7JRrbG")
end)
...
AddEventHandler("SneakyLog:Bring",function(id)
    ...
    sendToDiscord("DriveRP", "[STAFF] Bring du joueur "..GetPlayerName(id), 47103, "https://discord.com/api/webhooks/1151181162031624243/L7jDvHVGTD0z4Fros0o_90EqVCoTRuUfHgRKNlxG_oYT7_AohUzokosnD2uSym7JRrbG")
end)
...
AddEventHandler("SneakyLog:Changerlejob",function(IdSelected, job, k)
    ...
    local namestaff = GetPlayerName(source)
    sendToDiscord("DriveRP", "[STAFF] Setjob de "..GetPlayerName(IdSelected).. " en " ..job.. " avec comme grade :  " ..k.." "..namestaff, 47103, "https://discord.com/api/webhooks/1151181162031624243/L7jDvHVGTD0z4Fros0o_90EqVCoTRuUfHgRKNlxG_oYT7_AohUzokosnD2uSym7JRrbG")
end)
...
AddEventHandler("SneakyLog:Changerlegroup",function(IdSelected, job, k)
    ...
    local namestaff = GetPlayerName(source)
    sendToDiscord("DriveRP", "[STAFF] Setgroup de "..GetPlayerName(IdSelected).. " en " ..job.. " avec comme grade :  " ..k.." "..namestaff, 47103, "https://discord.com/api/webhooks/1151181162031624243/L7jDvHVGTD0z4Fros0o_90EqVCoTRuUfHgRKNlxG_oYT7_AohUzokosnD2uSym7JRrbG")
end)
...
AddEventHandler("SneakyLog:Voirinventaire",function(IdSelected)
    ...
    local namestaff = GetPlayerName(source)
    if IdSelected == nil or namestaff == nil then return end
    sendToDiscord("DriveRP", "[STAFF] À vu l'inventaire de "..GetPlayerName(IdSelected), 47103, "https://discord.com/api/webhooks/1151181162031624243/L7jDvHVGTD0z4Fros0o_90EqVCoTRuUfHgRKNlxG_oYT7_AohUzokosnD2uSym7JRrbG")
end)
...
AddEventHandler("SneakyLog:Givecash",function(IdSelected,montant)
    ...
    local namestaff = GetPlayerName(source)
    sendToDiscord("DriveRP", "[STAFF] À donner de l'argent à "..GetPlayerName(IdSelected).." d'un montant de : "..montant, 47103, "https://discord.com/api/webhooks/1151181162031624243/L7jDvHVGTD0z4Fros0o_90EqVCoTRuUfHgRKNlxG_oYT7_AohUzokosnD2uSym7JRrbG")
end)
...
AddEventHandler("SneakyLog:Givebank",function(IdSelected,montant)
    ...
    local namestaff = GetPlayerName(source)
    sendToDiscord("DriveRP", "[STAFF] À donner de l'argent en banque à "..GetPlayerName(IdSelected).." d'un montant de : "..montant, 47103, "https://discord.com/api/webhooks/1151181162031624243/L7jDvHVGTD0z4Fros0o_90EqVCoTRuUfHgRKNlxG_oYT7_AohUzokosnD2uSym7JRrbG")
end)
...
AddEventHandler("SneakyLog:Givedirty",function(IdSelected,montant)
    ...
    local namestaff = GetPlayerName(source)
    sendToDiscord("DriveRP", "[STAFF] À donner de l'argent sale à "..GetPlayerName(IdSelected).." d'un montant de : "..montant, 47103, "https://discord.com/api/webhooks/1151181162031624243/L7jDvHVGTD0z4Fros0o_90EqVCoTRuUfHgRKNlxG_oYT7_AohUzokosnD2uSym7JRrbG")
end)
...
AddEventHandler("SneakyLog:Giveitem",function(IdSelected,nomitem,amount)
    ...
    sendToDiscord("DriveRP", "[STAFF] À donner un item : "..nomitem.."("..amount..") à "..GetPlayerName(IdSelected), 47103, "https://discord.com/api/webhooks/1151181162031624243/L7jDvHVGTD0z4Fros0o_90EqVCoTRuUfHgRKNlxG_oYT7_AohUzokosnD2uSym7JRrbG")
end)
...
AddEventHandler("SneakyLog:Avertissement",function(IdSelected,reason)
    ...
    sendToDiscord("DriveRP", "[STAFF] À averti un joueur : "..GetPlayerName(IdSelected).." avec comme raison "..reason, 47103, "https://discord.com/api/webhooks/1151181162031624243/L7jDvHVGTD0z4Fros0o_90EqVCoTRuUfHgRKNlxG_oYT7_AohUzokosnD2uSym7JRrbG")
end)
...
AddEventHandler("SneakyLog:ReportTake",function(index,id)
    ...
    sendToDiscord("DriveRP", "[STAFF] À prit le report n°"..index, 47103, "https://discord.com/api/webhooks/1151181162031624243/L7jDvHVGTD0z4Fros0o_90EqVCoTRuUfHgRKNlxG_oYT7_AohUzokosnD2uSym7JRrbG")
end)
function sendToDiscord(name, message, color, webhook)
    ...
    local DISCORD_NAME = "DriveRP - Logs"
    local DISCORD_IMAGE = "https://cdn.discordapp.com/attachments/1186781950791401624/1186789454426419240/V8_-_Test_Logo.png?ex=659486cf&is=658211cf&hm=8acaae57f8730c0f61a733cb7a13ac8587cf0d4e9679faaee18a3c3b14bbdf57&"
...
AddEventHandler("SneakyLife:StaffState", function(state, sneaky)
    local source = source
    local byState = {
        [true] = "[~q~Staff~s~]~c~ %s ~s~est désormais ~q~actif ~s~en mode staff.",
        [false] = "[~q~Staff~s~]~c~ %s ~s~a ~r~désactivé ~s~son mode staff."
    }
    if state then
...
RegisterCommand("report", function(source, args)
    ...
    if reportsTable[source] ~= nil then
        TriggerClientEvent("esx:showNotification", source, "~q~[Report]~s~~n~Vous avez déjà un report actif.")
        return
    end
    ...
    notifyActiveStaff("[~q~Report~s~]~n~Un nouveau report a été reçu. ID Unique: ~q~" .. reportsCount)
    TriggerClientEvent("esx:showNotification", source, "[~q~Report~s~]~n~Votre report a été envoyé ! Vous serez informé quand il sera pris en charge et / ou cloturé.")
    updateReportsForStaff()
end, false)
...
--[[    if xPlayer.getGroup() == "user" then
    ...
    if not reportsTable[reportId] then
        TriggerClientEvent("esx:showNotification", source, "[~q~Report~s~]~n~Ce report n'est plus en attente de prise en charge.")
        return
    end
    reportsTable[reportId].takenBy = GetPlayerName(source)
    reportsTable[reportId].taken = true
    if players[reportId] ~= nil then
        TriggerClientEvent("esx:showNotification", reportId, "[~q~Report~s~]~n~Votre report à été pris en charge par le staff ~c~"..GetPlayerName(source).."~s~.")
    end
    notifyActiveStaff("[~q~Report~s~]~n~Le staff ~c~"..GetPlayerName(source).."~s~ a pris en charge le report ~q~n°"..reportsTable[reportId].uniqueId)
...
AddEventHandler("SneakyLife:CloseReport", function(reportId)
    ...
    if not reportsTable[reportId] then
        TriggerClientEvent("esx:showNotification", source, "[~q~Report~s~]~n~Ce report n'est plus valide.")
        return
    end
    if players[reportId] ~= nil then
        TriggerClientEvent("esx:showNotification", reportId, "[~q~Report~s~]~n~Votre report à été cloturé. N'hésitez pas à nous recontacter en cas de besoin.")
    end
    notifyActiveStaff("[~q~Report~s~]~n~Le staff ~c~"..GetPlayerName(source).."~s~ à cloturé~s~ le report ~q~n°"..reportsTable[reportId].uniqueId)
