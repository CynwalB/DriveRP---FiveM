...
function OpenCreatorMenu()
    if b.Menu then
        ...
        RMenu.Add('creator', 'characteroptionsaccessories', RageUI.CreateSubMenu(RMenu:Get("creator", "character"), "",
            "Création d'identité deDriveRP~s~."))
        ...
        RMenu.Add('creator', 'characteroptions_a',
            RageUI.CreateSubMenu(RMenu:Get("creator", "characteroptionsaccessories"), "",
                "Création d'identité de DriveRP~s~."))
        RMenu:Get('creator', 'main'):SetSubtitle("Création d'identité de DriveRP~s~.")
            ...
            while b.Menu do
                RageUI.IsVisible(RMenu:Get('creator', 'main'), true, false, true, function()
                    ...
                    if sIdentityEnd then
                        RageUI.Button("Créer son identité.", "Drive~q~RP~s~.", {
                            RightLabel = "→"
                        }, true, function(k, l, m)
                    ...
                    if sCharEnd then
                        RageUI.Button("Créer son personnage.", "Drive~q~RP~s~.", {
                            RightLabel = "→"
                        }, true, function(k, l, m)
                        end, RMenu:Get("creator", "character"))
                    else
                        RageUI.Button("Vous avez terminé votre personnage.", "Drive~q~RP~s~.", {
                            RightLabel = "→"
                        }, false, function()
                        end)
                    end
                    if not sIdentityEnd and not sCharEnd then
                        RageUI.Button("Commencer l'aventure.", "Drive~q~RP~s~.", {
                            RightLabel = "→",
                            Color = {
                ...
                RageUI.IsVisible(RMenu:Get('creator', 'identity'), true, false, true, function()
                    FreezeEntityPosition(GetPlayerPed(-1), true)
                    RageUI.Button("Prénom", "Drive~q~RP~s~.", {
                    ...
                    RageUI.Button("Nom", "Drive~q~RP~s~.", {
                    ...
                    RageUI.Button("Taille", "Drive~q~RP~s~.", {
                    ...
                    RageUI.Button("Date de naissance (16/02/2024)", "Drive~q~RP~s~.", {
                        RightLabel = sDataIdentity.birthday
                    }, true, function(k, l, m)
                        if m then
                            local r = sKeyboardInput("Date de naissance (16/02/2024)", "", 20)
                            if r ~= nil then
                    ...
                    if sDataIdentity.lastname ~= "" and sDataIdentity.firstname ~= "" and sDataIdentity.height ~= "" and
                        ...
                        RageUI.Button("Confirmer son identité.", "v.", {
                            RightLabel = "→",
                            Color = {
                                HightLightColor = {0, 158, 255, 160},
                                BackgroundColor = {0, 178, 255, 160}
                ...
                RageUI.IsVisible(RMenu:Get('creator', 'character'), true, false, true, function()
                    ...
                    for x, y in pairs(Components) do
                        if y.name == 'sex' then
                            RageUI.Button(y.label, "Drive~q~RP~s~.", {
                                RightLabel = "→"
                            }, true, function(k, l, m)
                                if l then
                                    f = y.zoomOffset;
                    ...
                    RageUI.Button("Visage", "Drive~q~RP~s~.", {
                        RightLabel = "→"
                    }, true, function(k, l, m)
                        if m then
                            GetComponents()
                    ...
                    RageUI.Button("Apparence", "Drive~q~RP~s~.", {
                        RightLabel = "→"
                    }, true, function(k, l, m)
                        if m then
                            GetComponents()
                    ...
                    RageUI.Button("Vetements", "Drive~q~RP~s~.", {
                        RightLabel = "→"
                    }, true, function(k, l, m)
                        if m then
                            GetComponents()
                    ...
                    RageUI.Button("Accessoires", "Drive~q~RP~s~.", {
                        RightLabel = "→"
                    }, true, function(k, l, m)
                        if m then
                            GetComponents()
                    ...
                    RageUI.Button("Terminer son personnage.", "Drive~q~RP~s~.", {
                        RightLabel = "→",
                        Color = {
                            HightLightColor = {0, 158, 255, 160},
                            BackgroundColor = {0, 178, 255, 160}
                    ...
                    for z, y in pairs(Components) do
                        if y.name == sData then
                            for B = 0, ComponentsMax[sData] do
                                RageUI.Button(y.label .. " N°" .. B, "Drive~q~RP~s~.", {
                                    RightLabel = "→"
                                }, true, function(k, l, m)
                                    if l then
                                        if sLoaded ~= B then
