...
--  {305.0498046875,-598.29693603516,43.292797088623-1.0, "docteur", 71.72, "", "s_f_y_scrubs_01", "",   scenario = nil, lib = nil, anim = nil},
  ...
  {-724.25059814453,-1334.89451904297,1.47034263611-1.0, "cop", 49.267, "", "s_m_y_cop_01", "",   scenario = nil, lib = nil, anim = nil},
  ...
  {270.121738525391,-1794.47729492,27.11898468017578-1.0, "mecano", 337.7, "", "ig_benny", "",   scenario = nil, lib = nil, anim = nil},
  {242.48884277344,-1799.048828125,27.772215881348-1.0, "bennys", 57.74, "", "u_m_y_smugmech_01", "",   scenario = nil, lib = nil, anim = nil},
  ...
  {22.445073699951,-1105.391259766,29.797208786011-1.0, "armurier", 159.22, "", "mp_m_exarmy_01", "",   scenario = nil, lib = nil, anim = nil},
...
RegisterCommand('infoperso', function(source, args)
  local plyData = ESX.GetPlayerData()
    ...
    ESX.ShowNotification("ID : ~q~"..GetPlayerServerId(NetworkGetPlayerIndexFromPed(PlayerPedId())).."\n~s~Métier : ~q~"..plyData.job.label.."~s~\nGrade : ~q~"..plyData.job.grade_label.."~s~\nOrganisation : ~q~"..plyData.job2.label.."~s~\nNom FiveM : ~q~" .. GetPlayerName(PlayerId()))
	else 
