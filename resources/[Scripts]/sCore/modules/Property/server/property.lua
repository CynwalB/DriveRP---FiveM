...
local function createProperty(data, author, street)
    ...
    if player then
        MySQL.Async.insert("INSERT INTO property (`owner`, `ownerInfo`, `infos`, `inventory`, `keys`, `createdAt`, `createdBy`, `street`) VALUES(@a, @b, @c, @d, @e, @f, @g, @h)", {
            ...
            TriggerClientEvent("esx:showNotification", author, "~q~Création de la propriété effectuée !")
    ...
    if xPlayer then
        ...
        if type == "item" then
            ...
            if exist then
                ...
                TriggerClientEvent("esx:showNotification", xPlayer.source, "Vous avez ajouté ~q~x"..count.." de "..ESX.GetItemLabel(name).."~s~ qui vous fais au total (~q~x"..lastCount+count.." "..ESX.GetItemLabel(name).."~s~) !")
                lastCount = 0
                exist = false
            else
                xPlayer.removeInventoryItem(name, count)
                ...
                TriggerClientEvent("esx:showNotification", xPlayer.source, "Vous avez ajouté ~q~x"..count.." de "..ESX.GetItemLabel(name).."~s~ !")
            end
        elseif type == "money" then
            ...
            if count > limitCount then return TriggerClientEvent("esx:showNotification", xPlayer.source, "~r~Vous n'avez pas cela sur vous !") end
                ...
                TriggerClientEvent("esx:showNotification", xPlayer.source, "Vous avez ajouté "..count.."~q~$~s~ de "..labelmoney.."~s~.")
                exist = false
        elseif type == "weapon" then
            ...
            TriggerClientEvent("esx:showNotification", xPlayer.source, "Vous avez déposé ~q~un(e) "..infoWeapon.label.."~s~ avec ~o~"..ammo.."munition(s)~s~ !")
        end
        ...
        if count > niceCount then
            ...
            if type == "money" then
                if name == "cash" then
                    ...
                    TriggerClientEvent("esx:showNotification", xPlayer.source, "Vous avez retirer "..count.."~q~$~s~ de "..labelmoney.." !")
                    TriggerClientEvent("sProperty:returnInventory", xPlayer.source, sPropertyManager.list[propertyId].inventory)
                    niceCount = 0
                    niceKle = 0
                    exist = false
            ...
            elseif type == "item" then
                ...
                TriggerClientEvent("esx:showNotification", xPlayer.source, "Vous avez retirer ~q~x"..count.." de "..ESX.GetItemLabel(name).."~s~ !")
                TriggerClientEvent("sProperty:returnInventory", xPlayer.source, sPropertyManager.list[propertyId].inventory)
                niceCount = 0
                niceKle = 0
                exist = false
            elseif type == "weapon" then
			    ...
			    if xPlayer.hasWeapon(itemName) then
                    ...
                    TriggerClientEvent("esx:showNotification", xPlayer.source, "Vous avez retirer ~q~x"..count.." de "..ESX.GetWeaponLabel(name).."~s~ avec ~o~"..ammo.."munition(s)~s~ !")
                    TriggerClientEvent("sProperty:returnInventory", xPlayer.source, sPropertyManager.list[propertyId].inventory)
                    niceCount = 0
                    niceKle = 0
                    exist = false
...
AddEventHandler("sProperty:addKeysAccess", function(propertyId, type, label, name)
    ...
    if type == "jobList" then
        ...
        TriggerClientEvent("esx:showNotification", source, "Vous avez donné les clé au métier ~q~"..label.."~s~ !")
    ...
    elseif type == "groupList" then
        ...
        TriggerClientEvent("esx:showNotification", source, "Vous avez donné les clé au groupe ~q~"..label.."~s~ !")
        TriggerClientEvent("sProperty:returnCallBackKeys", -1, sPropertyManager.list[propertyId].keys)
        TriggerClientEvent("sProperty:returnPlayerAcces", -1, propertyId, nil)
        onRequest = false
        nice = true
    elseif type == "person" then
        if name then
            ...
            if player then
                ...
                TriggerClientEvent("esx:showNotification", source, "Vous avez donné les clé à ~q~"..player.name.."~s~ !")
                TriggerClientEvent("sProperty:returnCallBackKeys", -1, sPropertyManager.list[propertyId].keys)
...
AddEventHandler("sProperty:removeKeysAccess", function(propertyId, type, label, name)
    ...
    if type == "jobList" then
        if sPropertyManager.Keys.jobList[name] == nil then return end
        TriggerClientEvent("esx:showNotification", source, "Vous avez retiré les clé au métier ~q~"..label.."~s~ !")
        TriggerClientEvent("sProperty:returnPlayerAcces", -1, propertyId, nil)
        onRequest = false
        nice = true
    elseif type == "groupList" then
        if sPropertyManager.Keys.groupList[name] == nil then return end
        TriggerClientEvent("esx:showNotification", source, "Vous avez retiré les clé au groupe ~q~"..label.."~s~ !")
        TriggerClientEvent("sProperty:returnPlayerAcces", -1, propertyId, nil)
        onRequest = false
        nice = true
    elseif type == "person" then
        if name then
            ...
            if player then
                TriggerClientEvent("esx:showNotification", source, "Vous avez retiré les clé à ~q~"..label.."~s~ !")
...
AddEventHandler("sProperty:requestInvitePlayer", function(propertyId, owner)
    ...
    if xPlayer then
        ...
        TriggerClientEvent("esx:showNotification", source, "~q~Sonnette~s~~n~Vous avez envoyer une demande !")
        ...
        if cbRequest == true then
            Property:enter(xPlayer.source, propertyId, owner)
            TriggerClientEvent("esx:showNotification", xPlayer.source, "Inviation~n~Le ~q~propriétaire~s~ à accepté votre invitation !")
        else
            TriggerClientEvent("esx:showNotification", xPlayer.source, "Inviation~n~Le ~q~propriétaire~s~ à refusé votre invitation !")
        end
