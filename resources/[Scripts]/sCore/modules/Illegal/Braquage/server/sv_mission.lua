...
mission = {
    {
        ...
        Desc = "Nous avons trouvé un véhicule rare qui se revend bien en pièces détachées. Attention, c'est un mafieu !",
        LongText = "Je t'ai indiqué le lieu, je te laisse y aller. Dépêche !",
    ...
    },
    {
        ...
        Desc = "Hum... il me semble qu'il y a un camion déposé quelque part, je te laisse aller le chercher mais fais attention !",
        LongText = "Je t'ai indiqué le lieu, je te laisse y aller. Dépêche !",
...

    {
        ...
        Desc = "Nous avons trouvé un véhicule type 'Windsor' de luxe, on veut que tu la ramènes.",
        LongText = "Je t'ai indiqué le lieu, je te laisse y aller. Dépêche !",
    ...
    },
    {
        ...
        Desc = "Nous avons trouvé un véhicule type 'Mesa', on veut que tu la ramènes.",
        LongText = "Je t'ai indiqué le lieu, je te laisse y aller. Dépêche !",
...

    {
        ...
        LongText = "Le lieu t'a été donné, vas récupérer le camion et méfie toi !",
...

    {
        ...
        Desc = "On va organiser un petit braquage mais qui nécéssite une préparation et un assez gros danger !",
