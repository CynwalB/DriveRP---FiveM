...
Labo = Labo or {}
Labo.Zone = {
	{pos = vector3(1038.14, -3205.45, -38.16), labocolor = "~q~", itemwin = "weed", itemcountwin = 5, itemrequired = "weed_graine", itemcountrequired = 5, itemrequired2 = "weed_fertiligene", itemcountrequired2 = 5, progress = {duration = 3200, name = "Traitement de votre weed", r = 0, g = 253, b = 93}, notif = "Appuyez sur ~INPUT_CONTEXT~ pour ~q~traiter votre weed~s~.", animID = 2, size = 2.5},

	{pos = vector3(978.17633056641,-146.64123535156,-48.9), labocolor = "~q~", itemwin = "meth", itemcountwin = 10, itemrequired = "meth_lode", itemcountrequired = 5, itemrequired2 = "meth_phosphore", itemcountrequired2 = 5, progress = {duration = 3200, name = "Traitement de votre meth", r = 0, g = 141, b = 223}, notif = "Appuyez sur ~INPUT_CONTEXT~ pour ~q~traiter votre meth~s~.", animID = 5, size = 2.5},
	{pos = vector3(985.88610839844,-141.49186706543,-48.999626159668), labocolor = "~b-~", itemwin = "meth_pooch", itemcountwin = 10, itemrequired = "meth", itemcountrequired = 10, progress = {duration = 3200, name = "Conditionnement de votre meth", r = 0, g = 141, b = 223}, notif = "Appuyez sur ~INPUT_CONTEXT~ pour ~q~conditionner votre meth~s~.", animID = 6, size = 2.5},

	{pos = vector3(1093.18, -3194.925, -39.60), labocolor = "~q~", itemwin = "coke", itemcountwin = 10, itemrequired = "coca_feuille", itemcountrequired = 5, itemrequired2 = "coca_acide", itemcountrequired2 = 5, progress = {duration = 3200, name = "Traitement de votre coke", r = 248, g = 226, b = 0}, notif = "Appuyez sur ~INPUT_CONTEXT~ pour ~q~traiter votre coke~s~.", animID = 3, size = 2.5},
	{pos = vector3(1101.245, -3198.82, -39.60), labocolor = "~q~", itemwin = "coke_pooch", itemcountwin = 10, itemrequired = "coke", itemcountrequired = 10, progress = {duration = 3200, name = "Conditionnement de votre coke", r = 248, g = 226, b = 0}, notif = "Appuyez sur ~INPUT_CONTEXT~ pour ~q~conditionner votre coke~s~.", animID = 4, size = 2.5},
}
                ...
                if not isPlayerVisite and not onFarming then
                    if not isPlayerLab then 
                            ...
                            if GetDistanceBetweenCoords(myCoords, labCoords.x, labCoords.y, labCoords.z,  true) < 2.0 then
                                ...
                                if v.owner == nil then
                                    ...
                                    if v.owner == ESX.PlayerData.job2.name then
                                        ESX.ShowHelpNotification("Appuyez sur ~INPUT_CONTEXT~ pour ~q~entrer~s~ dans le laboratoire.")
                                        if IsControlJustReleased(0, 38) then
                        ...
                        if GetDistanceBetweenCoords(GetEntityCoords(PlayerPedId()), 1034.6514892578,-3205.5776367188,-38.176643371582, true) < 2.0 then
                            nofps = true
                            ESX.ShowHelpNotification("Appuyez sur ~INPUT_CONTEXT~ pour mettre en ~q~pochon~s~.")
                            if IsControlJustReleased(0, 38) then
...
AddEventHandler("sLaboratoire:StartAttack",function(jobname)
    if not startattack then
        ...
        if cancelattack then
            ...
            cooldownattack = true
            ESX.RemoveTimerBar()
            ShowAboveRadarMessage("~r~Vous avez fuit la zone.")
            SetTimeout(3600000, function()
                cooldownattack = false
                cancelattack = false
                stopattackdead = false
